...
function cplexSolve()
    ...
    @constraint(m, [i in 2:n, j in 1:6, t in 1:31], E[i, j, t]-E[i, j, t+1]==sum(C[i, j, t, d] for d in 1 : 4) + C[i-1, j, t, 1] + C[i+1, j, t, 2] + C[i, j+1, t, ])
    ...
    @constraint(m, [i == 2:n, j in 1:n, t in 1:31], E[i, j, t]-E[i, j, t+1]==sum(C[i, j, t, d] for d in 1 : 4) + C[i-1, j, t, 1])
